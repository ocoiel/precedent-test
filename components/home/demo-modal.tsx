...
const DemoModal = ({
  ...
  return (
    <Modal showModal={showDemoModal} setShowModal={setShowDemoModal}>
      <div className="w-full overflow-hidden dark:border-gray-700 dark:shadow-xl dark:shadow-slate-700 md:max-w-md md:rounded-2xl md:border md:border-gray-100 md:shadow-xl">
